...
object ImageUtils {
    ...
    // Calculate optimal image resize
    ...
    // Get the downsampled image with specific width and height
    ...
    // Read the size of the image from uri stream, calculate the sample size, load in downsampled image
